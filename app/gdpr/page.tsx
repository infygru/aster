      ...
      >
        ...
        <div className="relative container-custom py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif text-white mb-6">GDPR Compliance Statement</h1>
            <p className="text-blue-100 text-lg">Aster Homecare UK LTD Data Protection Commitment</p>
          </div>
        </div>
      </section>
