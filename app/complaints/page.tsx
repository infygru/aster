      ...
      >
        ...
        <div className="relative container-custom py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif text-white mb-6">Complaints Procedure</h1>
            <p className="text-blue-100 text-lg">We welcome all forms of feedback to improve our services.</p>
          </div>
        </div>
      </section>
